  ...
  <div class="app-shell">
    ...
    <section class="main-shell">
      <header class="top-bar">
        <div>
          <p class="top-eyebrow">{{ authStore.user?.communityName || '管理后台' }}</p>
          <h1>{{ pageTitle }}</h1>
        </div>
...
import { LayoutDashboard, Building2, Users, UserCircle, MonitorSmartphone, AlertTriangle, ShieldCheck, LogOut } from 'lucide-vue-next'
